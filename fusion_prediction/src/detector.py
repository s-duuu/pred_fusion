...
sys.path.append('/home/heven/pred_ws/src/pred_fusion/fusion_prediction/src')
...
class Yolov5Detector:
    def __init__(self):
        ...
        self.pred_pub = rospy.Publisher(
            rospy.get_param("~output_topic"), CameraBBoxes, queue_size=10
        )
